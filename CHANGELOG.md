...
- `value_unformatted` per key figure: renders the number without the locale's thousands separator, so
  values that are not amounts (e.g. years) are shown as `1989` instead of `1.989`
...
[Unreleased]: https://github.com/oliverthiele/ot-countup/compare/v1.1.0...HEAD
[1.1.0]: https://github.com/oliverthiele/ot-countup/compare/v1.0.2...v1.1.0
